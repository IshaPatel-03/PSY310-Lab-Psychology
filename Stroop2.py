...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ishapatel/Desktop/PSY310_Lab/Stroop2.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    ins = visual.TextStim(win=win, name='ins',
        text="Instructions: You will be presented with text. Ignore the meaning of the text and press the key 'r' if the font colour is red and press the key ' b' if the font colour is blue. Press SPACE once you are ready to begin. ",
        font='Arial',
        units='pix', pos=(0,0), draggable=False, height=1.0, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=0.0);
    key = keyboard.Keyboard(deviceName='defaultKeyboard')
    ...
    text = visual.TextStim(win=win, name='text',
        text='',
        font='Arial',
        units='pix', pos=[0,0], draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-1.0);
    ...
    if key.keys != None:  # we had a response
        ...
        thisExp.addData('key.duration', key.duration)
    thisExp.nextEntry()
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/ishapatel/Desktop/PSY310_Lab/psychopy1StroopTaskCond.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    while continueRoutine and routineTimer.getTime() < 2.0:
        ...
        if thankyou.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
        ...
        # has the Routine been forcibly ended?
        if thank.forceEnded or routineForceEnded:
            break
        # has every Component finished?
        continueRoutine = False
        for thisComponent in thank.components:
